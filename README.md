...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/model_bakery-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9215&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/model_bakery-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `model_bakery` can be installed with:

```
conda install model_bakery
```

It is possible to list all of the versions of `model_bakery` available on your platform with:
